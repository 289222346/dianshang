...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/webpage/com/myjdbc/dsshow/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="/webpage/com/myjdbc/dsshow/css/skin.css" rel="stylesheet" type="text/css" />
		<script src="/webpage/com/myjdbc/dsshow/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="/webpage/com/myjdbc/dsshow/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
			...
			<div class="am-container header">
				<ul class="message-l">
					<div class="topMessage">
						<div class="menu-hd">
							<a href="login.jsp" target="_top" class="h">亲，请登录</a>&nbsp&nbsp
				...
				<div class="nav white">
					...
					<div class="search-bar pr">
						...
						<form>
							<input id="searchInput" name="index_none_header_sysc" type="text" placeholder="搜索" style="font-size:15px;font-weight:300" autocomplete="off">
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/33.jpg" /></a></li>
								<li class="banner2"><a><img src="/webpage/com/myjdbc/dsshow/images/34.jpg" /></a></li>
<!-- 								<li class="banner3"><a><img src="/webpage/com/myjdbc/dsshow/images/37.jpg" /></a></li> -->
								<li class="banner4"><a><img src="/webpage/com/myjdbc/dsshow/images/35.jpg" /></a></li>
...
<!-- 						    </div> -->
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/xy.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/2233.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/webpage/com/myjdbc/dsshow/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="/webpage/com/myjdbc/dsshow/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/webpage/com/myjdbc/dsshow/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/webpage/com/myjdbc/dsshow/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/webpage/com/myjdbc/dsshow/images/moneysmall.jpg" />
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="/webpage/com/myjdbc/dsshow/images/TJ2.jpg"></img>
									<span>[特惠]</span>低价药品1分秒
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[特惠]</span>商城满50包邮活动
								     <img src="/webpage/com/myjdbc/dsshow/images/TJ.jpg"></img>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="person/index.html">
									<img src="/webpage/com/myjdbc/dsshow/images/getAvatar.do.jpg">
								</a>
								<em>
							...
							<div class="clear"></div>
								...
								<li><a target="_blank" href="#"><span>[特惠]</span>新年大礼包来啦</a></li>
								<li><a target="_blank" href="#"><span>[公告]</span>医改药价改革招投标武汉</a></li>
<!-- 								<li><a target="_blank" href="#"><span>[特惠]</span>家电狂欢千亿礼券 买1送1！</a></li> -->

							</ul>
                        <div class="advTip"><img src="/webpage/com/myjdbc/dsshow/images/555.jpg"/></div>
<!--                          <div class="advTip"><img src="/webpage/com/myjdbc/dsshow/images/advTip.jpg"/></div> -->
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="/webpage/com/myjdbc/dsshow/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
...
<!-- 								<h4>让爱早回家</h4> -->
							...
							<div class="recommendationMain one">
								<a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/tj1.jpg "></img></a>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="/webpage/com/myjdbc/dsshow/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="/webpage/com/myjdbc/dsshow/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/51.jpg "></a>
							</div>
<!-- 							<div class="info "> -->
<!-- 								<h3>春节送礼优选</h3> -->
<!-- 							</div>														 -->
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>
							<h4>特惠</h4>
							<div class="activityMain ">
								<a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/56.jpg "></a>
							</div>
<!-- 							<div class="info "> -->
<!-- 								<h3>春节送礼优选</h3>								 -->
<!-- 							</div>							 -->
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/53.jpg "></a>
							</div>
<!-- 							<div class="info "> -->
<!-- 								<h3>春节送礼优选</h3> -->
<!-- 							</div>							 -->
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<a href="introduction.html"><img src="/webpage/com/myjdbc/dsshow/images/59.jpg "></a>
							</div>
<!-- 							<div class="info "> -->
<!-- 								<h3>春节送礼优选</h3> -->
<!-- 							</div>													 -->
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="/webpage/com/myjdbc/dsshow/images/act1.png " />
							</a>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								...
								<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/2.jpg" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/yp1.jpg" /></a>
							</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/5.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/3.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/4.jpg" /></a>
						</div>
                 ...
                 <div class="clear "></div>
					...
					<div class="am-g am-g-fixed floodThree ">
						...
						<div class="am-u-sm-4 text-four">
							<a href="# ">
								<img src="/webpage/com/myjdbc/dsshow/images/6.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-4 text-four sug">
							<a href="# ">
								<img src="/webpage/com/myjdbc/dsshow/images/7.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five big ">
							<a href="# ">
								<img src="/webpage/com/myjdbc/dsshow/images/10.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five ">
							<a href="# ">
								<img src="/webpage/com/myjdbc/dsshow/images/8.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five sug">
							<a href="# ">
								<img src="/webpage/com/myjdbc/dsshow/images/9.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="/webpage/com/myjdbc/dsshow/images/1.jpg" /></a>
							</div>
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="/webpage/com/myjdbc/dsshow/images/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名sl1903</li>
									<li>级&nbsp;别普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="/webpage/com/myjdbc/dsshow/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="/webpage/com/myjdbc/dsshow/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="/webpage/com/myjdbc/dsshow/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script>
			window.jQuery || document.write('<script src="/webpage/com/myjdbc/dsshow/basic/js/jquery.min.js "><\/script>');
		</script>
