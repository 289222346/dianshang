...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="commodityBaseInfoController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="categoryId" name="categoryId" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入商品种类ID"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="price" name="price" type="text" maxlength="22" class="form-control input-sm" placeholder="请输入价格"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="commodityName" class="form-control" rows="6" style="width: 600px" name="commodityName"  ignore="ignore" ></textarea>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="imageUrl" class="form-control" rows="6" style="width: 600px" name="imageUrl"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
